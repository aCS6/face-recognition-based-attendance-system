...
class WelcomeWindow:
    ...
    def __init__(self):
        ...
        self.canvas = Canvas(self.win, width=600, height=400, bg='blue')
        ...
        self.win.title("WELCOME | SMS | ADMINISTRATOR")
    ...
    def add_frame(self):
        ...
        self.img = PhotoImage(file='/home/amir/Documents/face/forms/icon/A.png')
        self.label = Label(self.frame, image=self.img)
        self.label.place(x=x+80, y=y+0)

        self.labeltitle = Label(self.frame, text="ABC Tech Student Management")
